...
#                                                                                                           #
# E é claro que eu colocaria um Easter Egg nesse projeto, como forma de divulgação deste singelo prdido de  #
# casamento, bem com para (estudo,) os calouros de Programação da Fametro que chegarem até aqui poderem falar pros seus    #
...
/* Você pode "Hacker" o Login, obtendo Usuário e Senha armazenados nesse .js, bem como acessando o endereço
 diretamente no navegador. Divirtam-se! :D */

function validate() {
    var username = document.getElementById("username").value;
    var password = document.getElementById("password").value;

    if (username == "Ruth" && password == "31032022") {
        window.location = "aceita.html";
        return false;
    }
    else {
        alerta();
...
function alerta() {
    swal("Desculpa!", "Não posso aceitar, você não parece ser Ruth Gomes! :(")
}
